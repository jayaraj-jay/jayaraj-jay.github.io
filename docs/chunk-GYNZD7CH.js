...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=E);var I=[t,f,c,m,o,u,n,U,l,p,v,d,a,s,x];for(let i of I)e.IncludesShadersStoreWGSL[i.name]||(e.IncludesShadersStoreWGSL[i.name]=i.shader);var B={name:r,shader:E};export{B as a};
