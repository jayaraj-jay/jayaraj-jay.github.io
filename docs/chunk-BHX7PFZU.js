import{a as i}from"./chunk-A7HZIVU3.js";import{a as e}from"./chunk-L3UYHT7M.js";var n="iblScaledLuminancePixelShader",o=`#include<helperFunctions>
...
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var deform: f32=sin(input.vUV.y*PI);var luminance: f32=fetchLuminance(input.vUV);fragmentOutputs.color=vec4f(vec3f(deform*luminance),1.0);}`;e.ShadersStoreWGSL[n]||(e.ShadersStoreWGSL[n]=o);var c=[i];for(let r of c)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var l={name:n,shader:o};export{l as a};
