import{a as l}from"./chunk-GNSHEPMZ.js";import{a}from"./chunk-A7HZIVU3.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-WSRQPLLG.js";var t="fibonacci",f=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=f);var o={name:t,shader:f};var i="diffusionProfile",s=`uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=s);var c={name:i,shader:s};var n="subSurfaceScatteringPixelShader",u=`#include<helperFunctions>
#include<fibonacci>
...
`;e.ShadersStoreWGSL[n]||(e.ShadersStoreWGSL[n]=u);var S=[a,o,l,c];for(let r of S)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var I={name:n,shader:u};export{I as subSurfaceScatteringPixelShaderWGSL};
