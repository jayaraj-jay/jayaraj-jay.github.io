import{a as e}from"./chunk-L3UYHT7M.js";var i="openpbrDielectricReflectance",t=`struct ReflectanceParams
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=t);var m={name:i,shader:t};var n="openpbrGeometryInfo",c=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);var u={name:n,shader:c};var r="openpbrIblFunctions",f=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=l);var O={name:a,shader:l};export{m as a,u as b,S as c,N as d,O as e};
