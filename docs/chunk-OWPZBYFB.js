import{a as s}from"./chunk-BLZUBSPM.js";import{a as n}from"./chunk-FMYQSHMG.js";import{a as o}from"./chunk-GZ7XB5MH.js";import{a as e}from"./chunk-L3UYHT7M.js";var r="spritesVertexShader",v=`attribute position: vec4f;attribute options: vec2f;attribute offsets: vec2f;attribute inverts: vec2f;attribute cellInfo: vec4f;attribute color: vec4f;uniform view: mat4x4f;uniform projection: mat4x4f;varying vUV: vec2f;varying vColor: vec4f;
...
}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=v);var f=[o,n,s];for(let t of f)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var x={name:r,shader:v};export{x as a};
