...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=c);var x=[l,s,f,o,a,u,d,i,n,p];for(let t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var T={name:r,shader:c};export{T as gaussianSplattingVertexShaderWGSL};
