import{a as r}from"./chunk-L3UYHT7M.js";var e="ltcHelperFunctions",t=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;r.IncludesShadersStoreWGSL[e]||(r.IncludesShadersStoreWGSL[e]=t);var c={name:e,shader:t};export{c as a};
