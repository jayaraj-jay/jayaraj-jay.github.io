import{a as e}from"./chunk-L3UYHT7M.js";var t="volumetricLightScatteringPixelShader",r=`uniform sampler2D textureSampler;uniform sampler2D lightScatteringSampler;uniform float decay;uniform float exposure;uniform float weight;uniform float density;uniform vec2 meshPositionOnScreen;varying vec2 vUV;
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=r);var a={name:t,shader:r};export{a};
