import{a as S}from"./chunk-AGDCOFVM.js";import{a as f}from"./chunk-ZZCNKXTM.js";import{a as n}from"./chunk-W7T5KP3Y.js";import{a as o}from"./chunk-2DV2UNWN.js";import{a as e}from"./chunk-L3UYHT7M.js";var a="bayerDitherFunctions",p=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=p);var s={name:a,shader:p};var t="shadowMapFragmentExtraDeclaration",c=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=c);var d={name:t,shader:c};var i="shadowMapPixelShader",m=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=m);var h=[f,s,d,n,o,S];for(let r of h)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var x={name:i,shader:m};export{x as a};
