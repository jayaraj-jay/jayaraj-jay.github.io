import{a as e}from"./chunk-L3UYHT7M.js";var i="uvAttributeDeclaration",o=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=o);var E={name:i,shader:o};var r="prePassVertexDeclaration",v=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=v);var N={name:r,shader:v};var t="samplerVertexDeclaration",a=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=a);var U={name:t,shader:a};var n="vertexPullingVertex",u=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=u);var A={name:n,shader:u};var s="prePassVertex",p=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=p);var R={name:s,shader:p};var f="uvVariableDeclaration",_=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=_);var W={name:f,shader:_};var d="samplerVertexImplementation",c=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=c);var g={name:d,shader:c};export{E as a,N as b,U as c,A as d,R as e,W as f,g};
