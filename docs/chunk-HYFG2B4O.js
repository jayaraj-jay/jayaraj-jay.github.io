import{a as e}from"./chunk-L3UYHT7M.js";var t="decalFragmentDeclaration",v=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=v);var p={name:t,shader:v};var r="prePassDeclaration",f=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);var h={name:r,shader:f};var o="oitDeclaration",i=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=i);var R={name:o,shader:i};var a="textureRepetitionFunctions",s=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);var D={name:a,shader:s};var d="depthPrePass",n=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=n);var P={name:d,shader:n};var c="oitFragment",l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var b={name:c,shader:l};export{p as a,h as b,R as c,D as d,P as e,b as f};
