import{a as i}from"./chunk-3O5R4FAK.js";import{a as e}from"./chunk-L3UYHT7M.js";var r="iblCdfyPixelShader",c=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;e.ShadersStore[r]||(e.ShadersStore[r]=c);var n=[i];for(let o of n)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);var a={name:r,shader:c};export{a};
