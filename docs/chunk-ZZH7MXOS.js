...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=r);var n={name:t,shader:r};var a="bakedVertexAnimation",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=m);var o={name:a,shader:m};export{n as a,o as b};
