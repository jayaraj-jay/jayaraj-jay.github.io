...
}`;e.ShadersStore[t]||(e.ShadersStore[t]=V);var u=[o,r,v,l,a,n,m,p,d,f,c,s];for(let i of u)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);var y={name:t,shader:V};export{y as a};
