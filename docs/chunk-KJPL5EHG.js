import{a as n}from"./chunk-RSLEHBQZ.js";import{a}from"./chunk-3O5R4FAK.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-WSRQPLLG.js";var i="fibonacci",l=`#define rcp(x) 1./x
#define GOLDEN_RATIO 1.618033988749895
vec2 Golden2dSeq(int i,float n)
{return vec2(float(i)/n+(0.5/n),fract(float(i)*rcp(GOLDEN_RATIO)));}
vec2 SampleDiskGolden(int i,int sampleCount)
{vec2 f=Golden2dSeq(i,float(sampleCount));return vec2(sqrt(f.x),TWO_PI*f.y);}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=l);var c={name:i,shader:l};var t="diffusionProfile",f="uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];";e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);var s={name:t,shader:f};var o="subSurfaceScatteringPixelShader",S=`#include<helperFunctions>
#include<fibonacci>
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;e.ShadersStore[o]||(e.ShadersStore[o]=S);var d=[a,c,n,s];for(let r of d)e.IncludesShadersStore[r.name]||(e.IncludesShadersStore[r.name]=r.shader);var D={name:o,shader:S};export{D as subSurfaceScatteringPixelShader};
