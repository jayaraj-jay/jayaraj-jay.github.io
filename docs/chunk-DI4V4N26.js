import{a as o}from"./chunk-3O5R4FAK.js";import{a as e}from"./chunk-L3UYHT7M.js";var i="iblIcdfPixelShader",c=`precision highp sampler2D;
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=c);var r=[o];for(let t of r)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var n={name:i,shader:c};export{n as a};
