import{a as s}from"./chunk-45LY63XP.js";import{a as o}from"./chunk-ITQCPGXT.js";import{a as e}from"./chunk-L3UYHT7M.js";var i="lightProxyVertexShader",n=`attribute position: vec3f;flat varying vOffset: u32;flat varying vMask: u32;
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);var r=[o,s];for(let t of r)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var x={name:i,shader:n};export{x as a};
