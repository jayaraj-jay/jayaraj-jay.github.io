import{a}from"./chunk-3O5R4FAK.js";import{a as e}from"./chunk-L3UYHT7M.js";var t="iblShadowVoxelTracingPixelShader",o=`precision highp sampler2D;precision highp sampler3D;
...
#endif
#endif
}`;e.ShadersStore[t]||(e.ShadersStore[t]=o);var r=[a];for(let i of r)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);var c={name:t,shader:o};export{c as a};
