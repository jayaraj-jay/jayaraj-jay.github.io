import{a}from"./chunk-A7HZIVU3.js";import{a as e}from"./chunk-L3UYHT7M.js";var t="iblIcdfPixelShader",c=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=c);var i=[a];for(let r of i)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var n={name:t,shader:c};export{n as a};
